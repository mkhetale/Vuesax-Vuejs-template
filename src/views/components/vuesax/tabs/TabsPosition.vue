...
<template>
	<vx-card title="Position" code-toggler>
		...
		<p>You can change the position of the menu with the property <code>vs-position</code> that as a value you can have: <code>top</code>, <code>right</code>, <code>bottom</code>, <code>left</code></p>
